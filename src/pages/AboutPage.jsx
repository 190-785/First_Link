...
const AboutPage = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-palePurple text-darkPurple px-4">
      <section className="max-w-3xl p-6 bg-lightPurple rounded-lg shadow-md w-full sm:w-10/12 md:w-8/12 lg:w-7/12 xl:w-6/12">
        ...
        <p className="text-lg mb-4">
          ...
          which explains the First Link Rule and its implications in an interesting and entertaining way. I highly recommend checking out the video to understand the concept better and see the rule in action. You can watch it{' '}
          <a
